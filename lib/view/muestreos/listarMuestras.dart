...
import 'package:agrotics/view/muestreos/detalleMuestras.dart';
import 'package:agrotics/view/muestreos/registroMuestras.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class ListarMuestras extends StatefulWidget {
  @override
  _ListarMuestrasState createState() => new _ListarMuestrasState();
}

class _ListarMuestrasState extends State<ListarMuestras> {
  Future<List> getData() async {
    final response = await http.get(Uri.parse(conexion()+"muestras/getdatamuestras.php"));
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (BuildContext context) => RegistroMuestras())),
                child: const Card(
                  child: ListTile(
                    leading: ImageIcon(
        ...
        return Container(
          ...
          child: GestureDetector(
            onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(
                      builder: (BuildContext context) => DetalleMuestras(
                            list: list,
                            index: i,
                          )),
                ),
