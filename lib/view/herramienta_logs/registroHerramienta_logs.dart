...
class RegistroHerramienta_logs extends StatefulWidget {
  @override
  _RegistroHerramienta_logsState createState() => _RegistroHerramienta_logsState();
}

class _RegistroHerramienta_logsState extends State<RegistroHerramienta_logs> {
