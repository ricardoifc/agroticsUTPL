...
import 'package:agrotics/view/menuCapturaPage.dart';
import 'package:agrotics/view/menuGestionPage.dart';
                ...
                child: RawMaterialButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => MenuGestionPage(username: username, rol: rol)));
                  },
            ...
            Visibility(
              ...
              child: Container(
                ...
                child: RawMaterialButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => MenuCapturaPage(username: username, rol: rol)));
                  },
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15.0),
                  ),
